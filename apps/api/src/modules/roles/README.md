...
- **Does not own:** Stylist profile content (Ch.6), authentication sessions (Ch.3)
...
| POST   | `/api/v1/staff/invitations/:invitationId/accept` | authenticated invitee  |
...
See [docs/PERMISSIONS.md](../../../../docs/PERMISSIONS.md) and [docs/SECURITY.md](../../../../docs/SECURITY.md).
