...
Owns business configuration per `docs/ARCHITECTURE.md`: bio, portfolio, structured pricing, policies, and availability rules.

- **Module path:** `apps/api/src/modules/stylist-profile/`
- **Tables:** `businesses` (extended), `business_policies`, `working_hours`, `schedule_exceptions`, `portfolio_items`, `service_offerings`, `style_categories`, `instagram_connections`
- **Routes:** `/api/v1/businesses/me/*`, public `/api/v1/style-categories`, `/api/v1/businesses/:businessId/services|policy`
...
| 6.2    | Portfolio upload-url, register, reorder, delete, 50-item limit                          |
