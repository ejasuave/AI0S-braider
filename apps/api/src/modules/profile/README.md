...
Directory listing/detail and `GET /profile/stylists/:id/booking-page` include `photoUrl` and per-service `offerings[].portfolio` galleries. Directory `coverImageUrl` prefers the profile photo, then the first portfolio image.
